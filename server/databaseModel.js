...
var init = function () {
  ...
  if (config['searchDatabase']) {
    ...
    app.get('/umock/databaseModel/tables', (req, res, next) => {

      var tableRowSql = `select * from information_schema.tables t where t.table_schema='${mysqlConfig.database}'`;
